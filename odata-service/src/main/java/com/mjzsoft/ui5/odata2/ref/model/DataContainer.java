...
/**
 * Container and initialization code for the data objects of the reference
 * scenario.
 * 
 */
public class DataContainer {
	...
	public void init() {
		...
		emp1.setImageUri("EmployeeSet('1')/$value");
		...
		emp2.setImageUri("EmployeeSet('2')/$value");
		...
		emp3.setImageUri("EmployeeSet('3')/$value");
		...
		emp4.setImageUri("EmployeeSet('4')/$value");
		...
		emp5.setImageUri("EmployeeSet('5')/$value");
		...
		emp6.setImageUri("EmployeeSet('6')/$value");
